...
<hr>
The goal here is to capture transmission from youtube service to EDGE browser, decode and render on my implementation of HTML parser. But this hard to solve for me right now. And simplest way to do this is to create random generator videos and run on localhost as python server and send data to this my browser engine. And then render on the same time 8 x 8 tiles as thumbnails 100 x 100 px. Which is 16 videos on the page at the same time. And when user click on this tile then user go to video transmission on 600x400 px video size. https://github.com/KarolDuracz/scratchpad/blob/main/Win32/web_renderer/todo_video/README.md
<br /><br />
yeah... here's a ready to run https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video part of web engine but I want to learn something on the low level about tthis. Today I know nothig. And exercise to build even the basic mechanisms of today's browser is what I've looking for few years ago.
