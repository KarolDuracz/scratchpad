24-04-2025 - I realized something. The only thing that makes sense at this point in this whole "Machine Learning" folder here is that I want to learn something. But the way I'm doing it is just stupid. This exercise make sense only when I really really want to learn why transformer came out that is, visualizing LSTM cells, GRU, and what are the differences between transformers that can be performed effectively on GPU. There are many questions about the algorithms themselves like AdamW. Ok. I know the sequence of mathematical formulas and implementations. But how does it work, HOW TO VISUALIZE IT to better understand how it works. Next. I haven't started this GPT-124M yet and I haven't understood what Andrej wrote in the first post https://github.com/karpathy/llm.c/discussions/481 . There's a ton of stuff to learn... I'm going about this the wrong way. First of all, I need to visualize a few things to understand the operation. I WILL RETURN TO THIS IN 2026, BECAUSE I DON'T REALLY UNDERSTAND ANY OF THIS RIGHT NOW. In the meantime, I need to change my approach to learning this subject. <b>I definitely need more practice before I post anything here because right now it's just bulshit</b>
<br /><br />
25-04-2025 - I wanted to take the path of least resistance, but subconsciously YESTERDAY I realized that I was doing something wrong, because the correct PIPELINE looks like Andrej showed here in this video https://www.youtube.com/watch?v=PaCmpygFfXo&ab_channel=AndrejKarpathy [The spelled-out intro to language modeling: building makemore] . We have some data -> there is a so-called "BLACK BOX" that means NEURAL NETWORK -> and we get predictions at the end of this pipeline. So we build a network methodically based on data in this exercise. I think I tried to skip this part of ML learning. But without that and without breaking down into prime factors what is happening inside this circle in this picture, i.e. inside the neural network and a METHODICAL APPROACH TO BUILDING STEP BY STEP BASED ON DATA E.G. a set of names .... I think that yesterday this entry subconsciously led me to understand that I was doing something wrong. That I do not have a methodical approach to building a network like here on this Makemore recording, where there is data and based on that the next steps are created. And then what happens in the network that IT WORKS, that it learns patterns. I think that yesterday I realized that I have the wrong approach.

![dump](https://github.com/KarolDuracz/scratchpad/blob/main/MachineLearning/ML%20with%20EurekaLabs/08-04-2025%20-%20EurekaLabs%20practice%20-%20update%20for%2025-03-2025%20demo/proper%20methodology%20step%20by%20step%20to%20build%20neural%20network%20I%20think.png?raw=true)

That's why I need break and some time to understood it. To understand proper "pipeline" of building and train neural network.
<hr>
