...
<br /><br />
So in this approach, with LLM you no longer wonder how to predict time series like on the stock market, but how to make the model more intelligent in tokens predictions.
