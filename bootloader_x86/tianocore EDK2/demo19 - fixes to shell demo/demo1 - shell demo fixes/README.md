...
This way, you can expand the font list and manipulate them, positioning colors, etc. (but as I wrote on the first page, I'm not so interested in GUI now, I'm more interested in going down to low-level hardware interacting) - But to show what can be achieved with this demo is really cool. <b>I've even started back a bit now, wanting to start exploring the Intel HD 3000, I realized it was too risky because I already know that some bits are set even though they're RESERVED. In my current level, I have to be careful. So I decided to stick with the standard GOP for now. I have two modes, enough to check other things.</b>
