...
<h3>How to run</h3>
1. You just put it in /EFI/Boot/myApps/<br />
2. So the comment "listapps" sees this<br />
3. you are loading "loading editor.efi"<br />
4. program lists the logs and waits for the index to be entered<br />
5. you press enter based on the information in the terminal and enter to log reader
<br /><br />
