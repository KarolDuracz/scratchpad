Update - 09-10-2025 - Kostr has a link to it at the bottom. Now that I looked a little more closely, there's an audio and AC97 demo. Definitely, there are probably many more interesting places on GitHub and the internet to explore -> https://github.com/zhenghuadai/uefi-programming/tree/master/book/audio
