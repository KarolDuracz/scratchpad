...
DefinitionBlock ("", "DSDT", 1, "_ASUS_", "Notebook", 0x00000000)
{
    ...
    Name (MBEC, 0x00)
    Name (MBLF, 0x0A)
    OperationRegion (GNVS, SystemMemory, 0xAAF9BE18, 0x01A8)
            ...
            Device (SBRG)
            {
                ...
                Device (PS2M)
                {
                    ...
                    Method (_CID, 0, NotSerialized)  // _CID: Compatible ID
                    {
                        If (\_SB.ELAN)
                        {
                            Return (CIDE) /* \_SB_.PCI0.SBRG.PS2M.CIDE */
                        }

                        If (\_SB.SYNA)
                        {
                            Return (CIDS) /* \_SB_.PCI0.SBRG.PS2M.CIDS */
                        }
                    }

                    Name (CIDS, Package (0x03)
                    {
                        0x000A2E4F, 
                        0x02002E4F, 
                        0x130FD041
                    })
                    Name (CIDE, Package (0x05)
                    {
                        0x0E0FD041, 
                        0x030FD041, 
                        0x120FD041, 
                        ...
                        Switch (ToInteger (Arg2))
                        {
                            ...
                            Case (0x04)
                            {
                                ...
                                Switch (ToInteger (HBDP))
                                {
                                    ...
                                    Default
                                    {
                                        NFBU [0x00] = HBDP /* \_SB_.PCI0.GFX0._DSM.HBDP */
                                    }
                            ...
                            Case (0x05)
                            {
                                ...
                                If ((Local1 & 0x01000000))
                                {
                                    ...
                                    Local0 = TLST /* \_SB_.PCI0.GFX0.TLST */
                                    Local1 = (Local0 << 0x08)
                                    Local1 |= 0x01
                                    Return (Local1)
                                }
                                ElseIf ((Local1 == 0x00))
                                {
                                    Local0 = DSM5 /* \_SB_.PCI0.GFX0.DSM5 */
                                    Return (Local0)
                                }
                            }
                            Case (0x06)
    ...
    Scope (\)
    {
        ...
        Method (OLPM, 0, Serialized)
        {
            If ((\_SB.ACPF == 0x00))
            {
                If ((\_SB.PCI0.SBRG.EC0.B0DC <= 0x0BB8))
                {
                    \_SB.SLMT = One
                }
            }
        ...
        Name (OPV1, Buffer (0xE6)
        {
            ...
            /* 0058 */  0x6E, 0x35, 0x33, 0x73, 0x76, 0x20, 0x62, 0x75,  // n53sv bu
            /* 0060 */  0x67, 0x20, 0x37, 0x34, 0x31, 0x37, 0x35, 0x20,  // g 74175 
            /* 0068 */  0x2D, 0x20, 0x59, 0x52, 0x46, 0x41, 0x3A, 0x4B,  // - YRFA:K
            /* 0070 */  0x3B, 0x43, 0x37, 0x46, 0x33, 0x48, 0x23, 0x3E,  // ;C7F3H#>
            /* 0078 */  0x47, 0x4B, 0x57, 0x39, 0x36, 0x36, 0x2B, 0x54,  // GKW966+T
            /* 0080 */  0x2A, 0x34, 0x27, 0x2D, 0x2C, 0x37, 0x54, 0x4F,  // *4'-,7TO
            /* 0088 */  0x32, 0x35, 0x33, 0x43, 0x25, 0x4D, 0x5C, 0x48,  // 253C%M\H
            /* 0090 */  0x2D, 0x3C, 0x57, 0x34, 0x51, 0x3B, 0x41, 0x2A,  // -<W4Q;A*
            /* 0098 */  0x24, 0x3B, 0x3C, 0x26, 0x5C, 0x34, 0x20, 0x2D,  // $;<&\4 -
        ...
        Name (OPV2, Buffer (0xE6)
        {
            ...
            /* 0050 */  0x6F, 0x72, 0x20, 0x61, 0x73, 0x75, 0x73, 0x20,  // or asus 
            /* 0058 */  0x6E, 0x35, 0x33, 0x73, 0x76, 0x20, 0x62, 0x75,  // n53sv bu
            /* 0060 */  0x67, 0x20, 0x32, 0x5F, 0x33, 0x20, 0x37, 0x20,  // g 2_3 7 
            /* 0068 */  0x2D, 0x20, 0x4C, 0x46, 0x2C, 0x38, 0x51, 0x22,  // - LF,8Q"
            /* 0070 */  0x54, 0x26, 0x50, 0x23, 0x50, 0x29, 0x40, 0x5E,  // T&P#P)@^
            /* 0078 */  0x21, 0x28, 0x2B, 0x5D, 0x4B, 0x50, 0x33, 0x3F,  // !(+]KP3?
            /* 0080 */  0x37, 0x5A, 0x33, 0x3A, 0x32, 0x41, 0x24, 0x5C,  // 7Z3:2A$\
            /* 0088 */  0x43, 0x4B, 0x44, 0x58, 0x53, 0x3B, 0x54, 0x41,  // CKDXS;TA
            /* 0090 */  0x23, 0x37, 0x53, 0x31, 0x57, 0x34, 0x41, 0x2B,  // #7S1W4A+
            /* 0098 */  0x26, 0x3E, 0x20, 0x2B, 0x42, 0x2B, 0x20, 0x2D,  // &> +B+ -
            /* 00A0 */  0x20, 0x43, 0x6F, 0x70, 0x79, 0x72, 0x69, 0x67,  //  Copyrig
            /* 00A8 */  0x68, 0x74, 0x20, 0x32, 0x30, 0x31, 0x30, 0x20,  // ht 2010 
            /* 00B0 */  0x4E, 0x56, 0x49, 0x44, 0x49, 0x41, 0x20, 0x43,  // NVIDIA C
            /* 00B8 */  0x6F, 0x72, 0x70, 0x6F, 0x72, 0x61, 0x74, 0x69,  // orporati
    ...
    Scope (\_SB.PCI0.PEG0)
    {
        Method (_STA, 0, Serialized)  // _STA: Status
        {
            If ((\_SB.PCI0.PEG0.SVID != 0xFFFFFFFF))
            {
                \_SB.PCI0.PEG0.NHDA = 0x00
                Sleep (0x32)
            }
    ...
    Scope (\_SB.PCI0.PEG0.GFX0)
    {
        ...
        Method (_ON, 0, NotSerialized)  // _ON_: Power On
        {
            ...
            Local0 = \_SB.PCI0.SBRG.EC0.RRAM (0x0521)
            Local0 &= 0xCF
            Local0 |= 0x20
        ...
        Method (_ROM, 2, NotSerialized)  // _ROM: Read-Only Memory
        {
            ...
            VBUF = ROMI /* \_SB_.PCI0.PEG0.GFX0._ROM.ROMI */
            Return (VBUF) /* \_SB_.PCI0.PEG0.GFX0._ROM.VBUF */
        }

        Method (_PS0, 0, NotSerialized)  // _PS0: Power State 0
        {
            \_SB.PCI0.GFX0._PSC = Zero
            If ((\_SB.PCI0.GFX0.DGPS != 0x00))
            {
                \_SB.PCI0.PEG0.GFX0.DON ()
                \_SB.PCI0.GFX0.DGPS = Zero
            }
        }

        Method (_PS3, 0, NotSerialized)  // _PS3: Power State 3
        {
            If ((\_SB.PCI0.GFX0.P3MO == 0x01))
            {
                \_SB.PCI0.PEG0.GFX0.DOFF ()
                \_SB.PCI0.GFX0._PSC = 0x03
                \_SB.PCI0.GFX0.DGPS = 0x01
            }

            \_SB.PCI0.GFX0.P3MO = 0x00
        }
    }
