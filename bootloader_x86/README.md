...
Now that I look at it, it would be better to organize it by topics, folders, etc. Anything, even a folder and a tree of subfolders, and pack it in a more sensible way than just throwing whatever I have at random. But it did work to some extent, because I moved forward  these topics a bit... 
